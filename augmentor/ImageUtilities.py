...
class AugmentorImage(object):
    ...
    def __init__(self,
        ...
        self._ground_truth_output_directory = ground_truth_output_directory
    ...
    @property
    def ground_truth_output_directory(self):
        """
        The :attr:`ground_truth_output_directory` property contains a path to the directory
        to which augmented ground-truth will be saved for this instance.

        :getter: Returns this ground-truth's output directory.
        :setter: Sets this ground-truth's output directory.
        :type: String         """

        return self._ground_truth_output_directory

    @output_directory.setter
    def output_directory(self, value):
        self._output_directory = value

    @ground_truth_output_directory.setter
    def ground_truth_output_directory(self, value):
        self._ground_truth_output_directory = value
...
def scan(source_directory, output_directory, ground_truth_output_directory):
    ...
    abs_ground_truth_output_directory = os.path.abspath(ground_truth_output_directory)
    ...
    if directory_count == 0:
        ...
        for d in directories:
            ...
            ground_truth_output_directory = os.path.join(abs_ground_truth_output_directory, os.path.split(d)[1])
